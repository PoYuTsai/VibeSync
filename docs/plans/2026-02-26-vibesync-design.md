...
| 方案 | 月費 (TWD) | 功能 |
|------|------------|------|
| **Free** | NT$0 | 5 次分析/月、基本熱度分析、廣告 |
| **Pro** | NT$149 | 200 次分析/月、完整 3 種回覆、無廣告、優先客服 |
| **Unlimited** | NT$299 | 無限分析、所有功能、API 優先、Beta 功能 |

### 6.2 功能對照表

| 功能 | Free | Pro | Unlimited |
|------|------|-----|-----------|
| 每月分析次數 | 5 | 200 | ∞ |
| 熱度分析 | ✓ | ✓ | ✓ |
| 延展回覆 | ✓ | ✓ | ✓ |
...
假設 MVP 上線 6 個月內達成：
- Free 用戶: 5,000 人 (不產生收入但產生口碑)
- Pro 用戶: 500 人 × NT$149 = NT$74,500/月
- Unlimited 用戶: 100 人 × NT$299 = NT$29,900/月

**預估月營收**: NT$104,400/月 (約 USD $3,300)
