...
|------|----------|----------------|------------|
| **Starter** | NT$100/月 | Tier 3 | $2.99 |
| **Pro** | NT$250/月 | Tier 8 | $7.99 |
| **Business** | NT$490/月 | Tier 15 | $14.99 |
...
|------|--------|----------|----------|
| Free | 5 | 3 | 體驗用，引導升級 |
| Starter | 30 | 5 | 30÷30=1/天，給5次緩衝 |
| Pro | 100 | 15 | 100÷30≈3/天，給15次重度用 |
| Business | 250 | 30 | 250÷30≈8/天，給30次高峰 |
...
INSERT INTO subscription_tiers VALUES
  ...
  ('starter', 30, 5, 'NT$100/月', 2.99, '{"extend": true, "resonate": true, "tease": true, "needy_alert": true}'),
  ('pro', 100, 15, 'NT$250/月', 7.99, '{"extend": true, "resonate": true, "tease": true, "needy_alert": true, "sonnet_priority": true}'),
  ('business', 250, 30, 'NT$490/月', 14.99, '{"extend": true, "resonate": true, "tease": true, "needy_alert": true, "sonnet_priority": true, "priority_support": true}');
```
