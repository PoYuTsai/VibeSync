...
Status: **OPEN — 修法二（軟版盤點契約）SHIPPED `c782e98`＋黑箱重打 FAILED（2026-06-13）：inventory 機制成功（模型現顯式列全 6 球標接/併/略、不再靜默吞），但選中風格仍 2 段、達不到 ≥3 含 msg1+msg4。根因已精準二分，待 Eric 拍板升級硬驗證（新 scoped task）**。
