...
Status: OPEN — **範例 1 草稿落檔，WAITING_ON_ERIC 逐句定稿**（`docs/plans/2026-06-12-voice-fewshot-example1-draft.md`；golden baseline 已留檔 `tools/voice-benchmark/baselines/`）。待拍板：slot 映射／resonate 補寫句／「江果先」字句確認（見草稿 D 節）
