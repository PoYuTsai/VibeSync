...
- cardReasons、pioneerPlan 與 openingStrategy 受同一份來源與限制約束：可給貼近她可能回答的一般接話方向，不必安排何時邀約，不保證她有興趣，不把她有回覆當成願意見面。對方有來源的明確限制優先，不推定她已同意；她明說不見面時，這些欄位都不建議再約；只寫「不約」而意思不明時保留不確定，不當成可以約。
