// Active AnalyzeChat base reasoning prompt.
// Rendered bytes are locked by baseline_contract_test.ts; this module owns
// composition only and must not change wording, ordering, or whitespace in Phase A.
