...
- 規則寫很多 → 不逐條回，也不旁路到規則本身（「會寫這麼多規則的人通常…」還是在讀她的規則）；旁路的對象永遠是規則以外的素材：職業、作息、照片。
...
## 輸出格式 (JSON)
{
  "wrongSurface": null,
  "profileAnalysis": {
    "bioComposition": "hooks | mixed | filter_heavy | none（先判自介組成再寫五句：可接線索為主／規則加線索混合／抱怨與篩選條件佔大半／幾乎沒自介）",
