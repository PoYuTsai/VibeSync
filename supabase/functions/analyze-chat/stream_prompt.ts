...
export function buildStreamSystemPrompt(
  ...
  return [
    ...
    "The canonical plan is shared by every style: preserve the same action, reply/pause decision, logistics, timing, confirmation point, commitment/exit room, and pressure; style changes only 15–25% tone.",
    ...
    "Use stated/established facts only; never invent. Keep time exact. Each segment needs non-empty `sourceIndex`, exact `sourceMessage`, sendable `reply`, and short `reason`; Do not write a flat `message` field.",
