...
export const MODEL_RATE_LIMITS = {
  ...
  // 單張截圖 compiler + judge：限制 provider amplification，不是訂閱額度。
  keyboard_assist: { perMinute: 6, perDay: 120 },
  ...
  // 練習室模擬社群動態（2026-08-24）：背景補生成，每次請求最多補 3 則。
  // 貼文是全域共用的，成本的絕對上界由 DB（每 profile-day 6 次）× Edge
