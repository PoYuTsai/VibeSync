 ...
 * 配圖機率（題材允許配圖時才擲）。
 *
 * 0.45 → 0.15（Eric 2026-08-22，D5a）：v1 只有自拍一種圖時的權宜值。
 * 0.15 → 0.2（Eric 2026-08-25 拍板）：20 張場景圖到位（#30/#31）後回調。
 * 不回到 0.45——那是 Threads 轉向（D5b 文字優先）之前的設計值；0.2 維持
 * 文字為主、約每 5 則出現一張圖。門檻位移不影響種子決定論。
 */
