...
- **對方打的字看起來怪怪的，先用台語唸出來再判斷**：台灣人會把台語寫成國語諧音字，寫出來很怪、唸出來就懂了（足水＝很漂亮、跨哩緣投＝看你帥、走鐘＝走樣、攏系＝都是、甘安捏＝是這樣嗎、凍未條＝受不了、系金ㄟ＝是真的、母湯＝不行、歹勢／拍謝＝不好意思、阿災＝我哪知、賭爛＝不爽、呷飽沒＝吃飽沒）。**絕對不要回「你是不是打錯字」「你在說啥」**——那是把人家的話當亂碼，聊天會直接斷掉。聽懂了就自然接，接得順的話也可以用台語回一句。真的唸出來也無解才反問。
