...
const nightMarketReview = <NightMarketReviewItem>[
  ...
  NightMarketReviewItem(
    ...
    detail:
        ...
        '失格之後，要真的看她怎麼接。她補了一句、多講了一點，你就根據她新給的資訊，給出有原因的讚賞；如果不管她說什麼你都繼續否定，那只是在走流程，不是在認識她。有沒有做過頭，不用貼標籤，看她接下來幾句怎麼回：還願意接話、反問或多分享，就可以繼續聊；接連幾次都回得很短、避開話題，就先別再逗她，也別急著邀約，回到正常聊天；明確說不想聊或要走，就收尾，不要再追著補話。一次沒接話，不代表你做錯。\n\n'
  ...
  NightMarketReviewChapter(
    ...
    explanations: [
      ...
      NightMarketReviewExplanation(
          ...
          detail:
              '「妳先忙，我回去找朋友」接在欣賞後面，語氣和動作才有前後的反差。這裡的失格是用行動收回一點注意力，不是加一句否定她的話；你收回的是自己的時間和注意力，不是對她的評價。她回「好啊」，只是接受你先走；之後願意加 IG，代表願意保持聯繫，還不能就此認定她被你吸引。有沒有做過頭，看她接下來幾句怎麼回：還願意接話、反問或多分享，就可以繼續聊；接連幾次都回得很短、避開話題，就先別再逗她，也別急著邀約；明確說要走，就收尾。一次沒接話，不代表你做錯。'),
    ],
    practice:
