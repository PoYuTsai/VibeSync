...
// 賦格／失格 wording supplemented from 聊天魅力教材（最終版）: 2026-09-16.
...
const nightMarketReview = <NightMarketReviewItem>[
  ...
  NightMarketReviewItem(
    ...
    term: '賦格',
    plain:
        '針對她真的表現出來的某個特質，說出你的讚賞。這讓她知道自己是因為哪一點而特別，也讓她看到你有自己的標準，不是只看外表就買單。欣賞的理由講清楚了，之後提加聯繫或見面，就有了「為什麼是妳」的答案。',
    practice:
        '先找出她做過的一件事，再說這件事讓你看到她什麼特質。讓欣賞落在具體的行為上，不要只停在「很棒」「很厲害」。平常可以先想好幾個你真的在意的特質，像是耐心、好奇、有自己的生活，現場看到了才講得出來。欣賞說完，前面又聊得有來有往，就可以主動提下一步：「因為這點，想繼續認識妳，加個 IG？」不必等她先開口；她要是明顯想結束，就自然收尾。',
    source:
        '第 11 集 10:39–11:06、15:01–15:09；達人篇 09 12:23–13:22；夜市「這點我蠻欣賞的」；聊天魅力教材（最終版）9.2、9.4、16.1.3、16.1.4、16.3.2、16.3.4、附錄 J-2。',
    tier: NightMarketReviewTier.more,
    detail:
        '賦格要有前文。開場誇外套，是讓她知道你對她有興趣；賦格要等她先分享一點自己，像是把手重做三次，你再說出你從這件事看到的特質。她主動講這件事，是在讓你認識她；你的賦格，就是接住這份分享、有原因的回應。順序顛倒，她還沒說什麼你就先誇，那只是恭維。\n\n'
        '欣賞可以有保留。她講的每件事不用都誇，你可以肯定一部分、保留一部分，像是「這點我欣賞，其他的還要再看」。什麼都誇，她會覺得已經贏得你了，反而沒有再多分享的理由。欣賞的是她這個人，不需要拿別人來比。\n\n'
        '欣賞和下一步可以分開講。這次是先欣賞她的耐心，過一下才提加 IG；理由前面已經說過了，提的時候就不用再解釋一遍。稱讚給的是理由，什麼時候提，看的是你們有沒有聊得有來有往。',
  ),
  NightMarketReviewItem(
    id: 'disqualification',
    term: '失格',
    plain:
        '在已經有認同、有興趣的互動裡，適時收回一點認同或注意力。目的不是讓她不安，而是讓她知道你有興趣了解她，但還在看合不合；你的欣賞是有標準的，不是無條件買單。這樣認同才有份量，她也有理由繼續讓你認識她。',
    practice:
        '先看看你們是不是已經有認同、有來有往，再決定什麼時候收回注意力。保留自己原本的安排就好，不用為了製造落差硬加一句貶低她的話。收回之後看她的反應再決定下一步：她接得住就繼續，她退了你也退。事後問自己一句：如果她不想繼續，我能不能自然收住，不生氣、不爭辯？',
    source:
        '第 11 集 08:55–09:01、11:55–12:22；夜市欣賞後收回注意力；聊天魅力教材（最終版）0.5.3、0.6、8.1、9.2、9.4、16.1.2、16.1.5、2.15、附錄 H-4。',
    tier: NightMarketReviewTier.more,
    detail:
        '失格有兩種做法。一種是用講的：說出一個真實的保留，像是「這點我欣賞，其他的還要再看」。另一種是用做的：像這次一樣，欣賞說完就照自己的安排先走。兩種都要接在真實的認同後面；你保留的是你們合不合、某個看法或小偏好，不是她這個人。\n\n'
        '失格之後，要真的看她怎麼接。她補了一句、多講了一點，你就根據她新給的資訊，給出有原因的讚賞；如果不管她說什麼你都繼續否定，那只是在走流程，不是在認識她。有沒有做過頭，不用貼標籤，看她接下來幾句怎麼回：還願意接話、反問或多分享，就可以繼續聊；接連幾次都回得很短、避開話題，就先別再逗她，也別急著邀約，回到正常聊天；若她明顯防備、受傷，或直接說不舒服，就先別再逗她，不必等到連續冷回。明確說不想聊或要走，就收尾，不要再追著補話。一次沒接話，不代表你做錯。\n\n'
        '失格不是裝冷淡。冷淡是演出來的，等著她來證明自己；失格是你真的有自己的安排和看法。好的張力，是她還是覺得安全、被尊重，而且想繼續聊。整段下來，欣賞要比退開多。',
    optional: true,
  ),
  NightMarketReviewItem(
    id: 'push_pull',
  ...
  NightMarketReviewChapter(
    ...
    explanations: [
      NightMarketReviewExplanation(
          ...
          title: '賦格｜先看見，再說出欣賞',
          text:
              '她說把手重做了三次，你因此欣賞她的耐心。這個讚賞是有原因的，也有回應到她剛給的資訊。它也幫下一段的加 IG 鋪好了理由：不是隨便誰都可以，而是因為欣賞她這一點，才想繼續認識她。',
          detail:
              '開場誇的是外套，那是誰都看得到的東西，作用是讓她知道你對她有興趣。現在欣賞的是她聊出來才有的做事態度，這是你認識她之後才給得出的讚賞。順序不能顛倒：她還沒分享什麼你就先誇，那只是恭維。這個轉變讓 Leah 知道，你在聊的過程中真的多認識了她一點，也知道自己是因為哪一點而特別。'),
      NightMarketReviewExplanation(
          knowledgeId: 'disqualification',
          title: '失格｜在有興趣的互動裡，退開一點',
          text:
              '欣賞說完，就照原本的安排回去找朋友。有前面的讚賞，退開才有份量；有後面的退開，讚賞才不會變成討好。她知道你欣賞她，也知道你還在看合不合、有自己的節奏，這段互動才有進有退。',
          detail:
              '「妳先忙，我回去找朋友」接在欣賞後面，語氣和動作才有前後的反差。這裡的失格是用行動收回一點注意力，不是加一句否定她的話；你收回的是自己的時間和注意力，不是對她的評價。她回「好啊」，只是接受你先走；之後願意加 IG，代表願意保持聯繫，還不能就此認定她被你吸引。有沒有做過頭，看她接下來幾句怎麼回：還願意接話、反問或多分享，就可以繼續聊；接連幾次都回得很短、避開話題，就先別再逗她，也別急著邀約；若她明顯防備、受傷，或直接說不舒服，就先別再逗她，不必等到連續冷回。明確說要走，就收尾。一次沒接話，不代表你做錯。'),
    ],
    practice:
        '先想清楚你到底欣賞她哪一點，把理由說出來，再照自己原本的安排收個尾。整段下來，欣賞要比退開多；不用每講一句就配一個相反的動作，退開只是讓欣賞更有份量。',
    knowledgeIds: [
      'qualification',
      'disqualification',
      'push_pull',
