...
const nightMarketReview = <NightMarketReviewItem>[
  ...
  NightMarketReviewItem(
    ...
    practice:
        '先找出她做過的一件事，再說這件事讓你看到她什麼特質。讓欣賞落在具體的行為上，不要只停在「很棒」「很厲害」。平常可以先想好幾個你真的在意的特質，像是耐心、好奇、有自己的生活，現場看到了才講得出來。欣賞說完，可以直接接下一步：「因為這點，想繼續認識妳，加個 IG？」',
    source:
    ...
    detail:
        ...
        '欣賞和下一步可以分開講。這次是先欣賞她的耐心，過一下才提加 IG；理由前面已經說過了，提的時候就不用再解釋一遍。',
  ),
  NightMarketReviewItem(
    id: 'disqualification',
    term: '失格',
    ...
    detail:
        ...
        '失格之後，要真的看她怎麼接。她補了一句、多講了一點，你就根據她新給的資訊，給出有原因的讚賞；如果不管她說什麼你都繼續否定，那只是在走流程，不是在認識她。有沒有做過頭，看她接下來幾句的反應：語氣輕鬆、她能笑著回你，就是張力；她變得防備、不講話，或是真的被傷到，就是過頭了，先回到正常聊天。她如果沒接、直接走了，那就是答案，不要再追著補話。\n\n'
  ...
  NightMarketReviewChapter(
    ...
    explanations: [
      ...
      NightMarketReviewExplanation(
          ...
          detail:
              '「妳先忙，我回去找朋友」接在欣賞後面，語氣和動作才有前後的反差。這裡的失格是用行動收回一點注意力，不是加一句否定她的話；你收回的是自己的時間和注意力，不是對她的評價。有沒有做過頭，要看她接下來的反應，不是只看這一句：她笑著說好、之後還願意接話，就是張力；她變得防備、不說話，或是沒有接，就已經過頭了，接下來就照她的意思，不要再追著補話。'),
    ],
    practice:
