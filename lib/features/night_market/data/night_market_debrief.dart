...
const nightMarketReview = <NightMarketReviewItem>[
  ...
  NightMarketReviewItem(
    ...
    tier: NightMarketReviewTier.mindset,
    detail: '一次對話沒接上，不代表你不值得被認識。回頭看當時說了什麼、她怎麼回應，把卡住的地方找出來，才知道下次可以練什麼。',
  ),
  NightMarketReviewItem(
    id: 'self_amusement',
    term: '自娛自樂感',
  ...
  NightMarketReviewItem(
    ...
    detail:
        '「第一分鐘」指的是剛接觸時建立信任的階段。她可能很快就願意聊，也可能需要多一點時間。留意她是否開始自在地回應，不用把六十秒當成固定門檻。',
  ),
  NightMarketReviewItem(
    id: 'opening',
    term: '打開',
  ...
  NightMarketReviewItem(
    ...
    tier: NightMarketReviewTier.more,
    detail:
        '失格也能透過行動表達。像說完欣賞之後，先回去找自己的朋友，把注意力放回原本的安排。前面的認同與後面的退開，讓她感覺你有自己的評估與節奏。',
    optional: true,
  ),
  NightMarketReviewItem(
    id: 'push_pull',
  ...
  NightMarketReviewItem(
    ...
    tier: NightMarketReviewTier.mindset,
    detail:
        '互動由你發起，也由你把遇到的狀況接起來。例如站在店門口擋到人流，就提議挪到旁邊；話題聊完了，就自然換題或收尾。知道自己接下來要做什麼，對方也比較容易跟上節奏。',
  ...
  NightMarketReviewItem(
    ...
    tier: NightMarketReviewTier.more,
    detail:
        '留意她是在禮貌地回應，還是情緒也跟著互動走：沒有刻意逗她時也會自發地笑、主動想多了解你，眼神也持續停留。把這些反應連起來看，才比較能判斷男女吸引是否正在發生。',
  ...
  NightMarketReviewItem(
    ...
    tier: NightMarketReviewTier.more,
    detail:
        '說一件真實發生的小事，讓她想像你的日常。像陪朋友去上陶藝課，最後卻自己不肯走，就同時帶出了朋友、興趣和做事的樣子；不用誇大經歷來證明自己。',
  ...
  NightMarketReviewItem(
    ...
    tier: NightMarketReviewTier.more,
    detail: '分享經歷時，也說說自己的偏好、感受與在意的事。她會從「你怎麼看這件事」認識你的個性，同一段故事也就多了一層交流。',
    sceneNote: '你說想做好的東西就會很龜毛，Leah 接著分享把手重做三次。你們從陶藝聊到了做事的態度，找到更具體的共同點。',
  ),
  NightMarketReviewItem(
    id: 'shit_test',
    term: '廢物測試',
    plain: '互動中遇到質疑或調侃，先聽懂她在表達什麼，再決定怎麼接。回應之後仍能維持自己的狀態，把話題接下去，別一直困在證明自己。',
    ...
    tier: NightMarketReviewTier.more,
    detail:
        '也叫一致性測試：遇到質疑時，你能否保持原本的確信感？先聽語氣與情緒，再選擇簡答後繼續、略過調侃，或逆轉框架——順著她的話輕鬆接回互動。若她明確拒絕，就按她表達的意思處理。',
  ...
  NightMarketReviewItem(
    id: 'handshake',
    term: '服從性測試（握手）',
    plain: '自我介紹後伸出手，邀請她握手，看看她是否願意回應。透過這樣的小互動，你可以觀察她當下是否自在、願不願意繼續交流，再決定後面的節奏。',
    practice: '留意她是否回應這次握手，以及回應時的狀態。這只能說明當下這個互動，後面仍要繼續觀察。',
    source: '第 11 集 16:09–16:13。',
    tier: NightMarketReviewTier.more,
    detail:
        '服從性測試是提出一個小互動，觀察對方是否願意配合。這次用握手來看她的回應；回握只代表她願意參與當下這個動作，之後仍要繼續留意她的反應。',
