...
const _s2Captions = <NightMarketCaption>[
  ...
  NightMarketCaption(
    ...
    end: Duration(milliseconds: 25720),
    speaker: NightMarketSpeaker.user,
    text: '我跟朋友來買東西，剛在那邊等她。看到妳，想過來打個招呼。你好，我叫 Chris。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 25970),
    end: Duration(milliseconds: 27200),
    speaker: NightMarketSpeaker.npc,
    text: '我叫 Leah。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 27390),
    end: Duration(milliseconds: 28240),
    speaker: NightMarketSpeaker.user,
    text: 'Leah。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 28610),
    end: Duration(milliseconds: 30220),
    speaker: NightMarketSpeaker.user,
    text: '妳今天自己來逛？',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 31110),
    end: Duration(milliseconds: 34740),
    speaker: NightMarketSpeaker.npc,
    text: '跟朋友，她還在那邊買吃的。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 35130),
    end: Duration(milliseconds: 37620),
    speaker: NightMarketSpeaker.user,
    text: '那我們現在都在等人。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 39030),
    end: Duration(milliseconds: 45280),
    speaker: NightMarketSpeaker.user,
    text: '妳看起來蠻會挑這種小東西的，應該不太喜歡跟大家買一樣的。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 45510),
    end: Duration(milliseconds: 49240),
    speaker: NightMarketSpeaker.npc,
    text: '也沒有啦，我只是蠻喜歡逛手作的。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 49550),
    end: Duration(milliseconds: 52800),
    speaker: NightMarketSpeaker.user,
    text: '妳是喜歡逛，還是自己也會做？',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 54490),
    end: Duration(milliseconds: 58440),
    speaker: NightMarketSpeaker.npc,
    text: '我有去上陶藝課，但做得不怎麼樣。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 59530),
    end: Duration(milliseconds: 61600),
    speaker: NightMarketSpeaker.user,
    text: '妳還真的自己下去做。',
  ),
  NightMarketCaption(
    start: Duration(milliseconds: 62530),
    end: Duration(milliseconds: 66380),
    speaker: NightMarketSpeaker.npc,
    text: '朋友找我去的，後來覺得蠻好玩。',
  ),
];
